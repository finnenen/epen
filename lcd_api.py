...
class LcdApi:
    ...
    # them to the LCD.
    #
    # It is expected that a derived class will implement the hal_write_command
    # and hal_write_data methods.
    #
    # The following constant names were lifted from the avrlib lcd.h header file,
    # with help from the Arduino LiquidCrystal library.
    ...
    def move_to(self, cursor_x, cursor_y):
        ...
        # position is zero based (i.e. cursor_x == 0 indicates the first
        # column).
        ...
        if cursor_y & 2:    # Lines 2 & 3 add 0x14
            addr += 0x14
    ...
    def hal_backlight_on(self):
        ...
        # If desired, a derived class can implement this function.
        pass
